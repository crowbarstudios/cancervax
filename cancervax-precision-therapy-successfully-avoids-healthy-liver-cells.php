<?php
$GLOBALS['title'] = "CancerVax Precision Therapy Successfully Avoids Healthy Liver Cells - CancerVax";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
<section class="news-detail">
    <div class="container">
        <div class="post-title">
            <h1>CancerVax Precision Therapy Successfully Avoids Healthy Liver Cells</h1>
        </div>
        ...
        <img src="./assets/img/health-liver-cells.png" alt="liver-toxicity" class="my-4 d-block mx-auto" style="max-width: 600px;">
