...
$news = [
    ...
    [
        ...
        ["<p>Lehi, Utah, December 23, 2025 - CancerVax, Inc., the developer of a breakthrough Universal Cancer Treatment Platform that uses the body’s immune system to treat cancer, today released a year-end summary highlighting significant advancements made throughout 2025. These achievements mark a transformative period in the Company’s development as it accelerates its mission to create safe, targeted, and broadly adaptable cancer treatments.</p>"],
        ["<p>Throughout 2025, CancerVax achieved substantial scientific progress, expanded its leadership and intellectual property portfolio, and advanced the development of its AI-engineered “Smart mRNA” and nanoparticle delivery technologies. These accomplishments position the Company for a strong 2026 as it moves toward in-vivo studies and continued platform expansion.</p>"],
        ["<p class=\"text-center underline\"><strong>Key Accomplishments Since January 2025</strong></p>"],
        ["<p><strong>Strengthened Scientific Leadership</strong> - Appointed a world-class biotech executive as Chief Scientific Advisor to guide platform development and strategic execution (<a href=\"single-news.php?id=32\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>). </p>"],
        ["<p><strong>Engineered Precision Cell-Targeting Nanoparticles</strong> - Developed ligand-conjugated lipid nanoparticles capable of identifying cancer-specific biomarkers. Validated selective uptake into cancerous cells while avoiding healthy cells. Demonstrated functionality of dual-key targeting architecture (Marker1 + Marker2), (<a href=\"single-news.php?id=34\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>). </p>"],
        ["<p><strong>Expanded Platform Capability to Aggressive Liver Cancers</strong> - Initiated research programs targeting hepatocellular carcinoma (HCC) and intrahepatic cholangiocarcinoma (ICC), (<a href=\"single-news.php?id=35\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>).</p>"],
        ["<p><strong>Breakthrough: Cancer Cells Successfully Disguised as Pathogens</strong> - Achieved proof-of-principle demonstrating cancer cells can be disguised as common pathogens to trigger immune attack (<a href=\"single-news.php?id=37\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>).</p>"],
        ["<p><strong>Filed Foundational PCT Patent Application</strong> - Submitted non-provisional PCT application protecting the universal cancer immunotherapy platform (<a href=\"single-news.php?id=39\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>).</p>"],
        ["<p><strong>Advanced Smart mRNA Activation Technology</strong> - Confirmed Smart mRNA remains inactive in healthy human liver cells and Smart mRNA only activates inside cancer cells, reducing off-target toxicity (<a href=\"single-news.php?id=41\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>).</p>"],
        ["<p><strong>Strong cancer cell uptake and Smart mRNA activation</strong> -  Recent In-vitro studies showed strong uptake of cell-targeting nanoparticles by cancer cells and strong activation of Smart mRNAs inside cancer cells, providing confidence in moving forward with animal testing (<a href=\"single-news.php?id=42\" target=\"_blank\" rel=\"noopener noreferrer\">see source</a>).</p>"],
        ["<h3>Platform Momentum and Path Toward 2026</h3>"],
        ["<p>As the Company plans for 2026, major milestones expected include: 1) Integration of nanoparticles with Smart mRNA to form full therapeutic nanoparticles. 2) Complete pre-IND animal studies to determine toxicity and efficacy in pancreatic and liver cancers. 3) Expand scientific collaborations and future IND groundwork.</p>"],
        ["<h3>CEO Statement</h3>"],
        ["<p>“Our progress in 2025 represents a turning point in the development of our universal cancer immunotherapy platform,” said Byron Elton, CEO of CancerVax. “This year, we shifted from theoretical possibility to validated scientific evidence. Our breakthroughs bring us significantly closer to delivering cancer treatments that are more precise, more accessible, and more humane.”</p>"],
        ["<p>To learn more about the CancerVax platform, please watch the Short Explainer Video at <a href=\"/explainer\" rel=\"noopener noreferrer\">https://cancervax.com/explainer</a> </p>"]
    ...
    [
        ...
        ["<p>Lehi, Utah, December 17, 2025 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform that uses the body’s immune system to treat cancer, today announced that recent in-vitro studies have confirmed that two key components of the Company’s novel technology performed exceptionally well. The next step is to put them together into a complete therapeutic lipid nanoparticle (“LNP”) for animal testing.</p>"],
        ["<p>The CancerVax platform is designed to harness the body’s existing immunity to detect, mark, and kill cancer cells with precision. At the core of the platform are customizable nanoparticles that use a two-step cell-targeting mechanism. </p>"],
        ["<ol class=\"list-[revert] pl-12 [&_li]:pl-3\">
            <li><p><strong>Detection:</strong> The nanoparticles first bind to surface proteins highly associated with the target cancer cells (“Marker1”).</p> </li>
            <li><p><strong>Activation:</strong> Once inside the cancer cell, the nanoparticles release proprietary “Smart mRNA” payloads that are only activated in the presence of cancer-specific genetic signatures (“Marker2”). These Smart mRNAs instruct the cancer cells to produce proteins associated with well-immunized diseases like measles. This effectively “tricks” the immune system into killing cancer cells as if they were common diseases.</p></li>
        </ol>"],
        ...
        ["<img src=\"./assets/images/nanoparticle-component.png\" alt=\"liver-toxicity\" class=\"my-4 hidden sm:block mx-auto w-full md:w-4/5\">"],
        ["<div class=\"block sm:hidden\">
            <img src=\"./assets/images/nanoparticle-component1.png\" alt=\"nanoparticle-component\" class=\"my-4 d-block mx-auto\">
            <img src=\"./assets/images/nanoparticle-component2.png\" alt=\"nanoparticle-component\" class=\"my-4 d-block mx-auto\">
        </div>"],
    ...
    [
        ...
        ["<p>Lehi, Utah, October 14, 2025 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform that uses the body’s immune system to treat cancer, today announced that recent in-vitro studies have confirmed that the Company’s technology could significantly reduce liver toxicity, a major problem with other cancer drugs. </p>"],
        ["<p>The liver is the main site for drug metabolism. Many cancer therapies, including those that the Company’s scientists have worked on in previous programs, fail in clinical trials because a significant portion of the drug ends up in the liver and causes liver damage or liver failure. Nearly all cancer drugs including chemotherapy, antibody-drug conjugates, CAR-T, PD-1/PD-L1 checkpoint inhibitors and others, have this problem.   </p>"],
        ["<p>This is why the science team at CancerVax leveraged AI and machine-learning techniques to carefully design its technology to avoid healthy tissues and organs such as the liver. </p>"],
        ["<p>The CancerVax platform is designed to harness the body’s existing immunity to detect, mark, and kill cancer cells with precision. At the core of the platform are nanoparticles that use a two-step cell-targeting mechanism.</p>"],
        ["<ol class=\"list-[revert] pl-12 [&_li]:pl-3\">
            <li><p><strong>Detection:</strong> The nanoparticles first bind to surface proteins highly associated with the target cancer cells (“Marker1”).</p> </li>
            <li><p><strong>Activation:</strong> Once inside the cancer cell, the nanoparticles release proprietary “Smart mRNA” payloads that are only activated in the presence of cancer-specific genetic signatures (“Marker2”). These Smart mRNAs instruct the cancer cells to produce proteins associated with well-immunized diseases like measles. This effectively “tricks” the immune system into killing cancer cells as if they were common diseases.</p></li>
        </ol>"],
        ["<p>In recent in-vitro studies, the Company successfully confirmed that its Smart mRNAs designed for pancreatic and liver cancers were dramatically deactivated in healthy human liver cells. In other words, the CancerVax nanoparticles will significantly de-target the liver and prevent healthy liver tissues from being misidentified as cancerous.</p>"],
        ["<img src=\"./assets/images/health-liver-cells.png\" alt=\"liver-toxicity\" class=\"my-4 block w-full md:w-[600px] mx-auto\">"],
        ["<p>Dr. George Katibah, Chief Scientific Officer, commented, “These results are striking. In previous experiments, we were using artificial non-cancerous cell models, such as HEK293, to prove our hypothesis. This is the first time we’re using human-derived healthy liver cells, and the results were incredibly exciting and rewarding to see. This gives us confidence that our targeted therapy will reduce potential harm to the liver and other major organs.”</p>"],
        ["<p>Dr. Adam Grant, Principal Scientist, added, “Our universal approach uses proprietary AI algorithms to mine the ever-growing databases of cancer genomics to find universal biomarkers for our Marker1 and Marker2. As a result, accessible off-the-shelf injections can be easily developed for multiple cancer types, instead of expensive custom therapies for individual patients. We believe some Marker1 and Marker2 combinations can be used for multiple cancer indications as well. In other words, a single version of our injection has the potential to treat patients across multiple cancer types. This reduces our drug cost dramatically, as there are approximately 200 cancer types compared to 8 billion individual people in the world.”</p>"],
        ["<p>To learn more about the CancerVax platform, please watch the Short Explainer Video at <a href=\"/explainer\" rel=\"noopener noreferrer\">https://cancervax.com/explainer</a> </p>"]
    ...
    [
        ...
        ["<p>Lehi, Utah – June 5, 2025 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform designed to use the body’s immune system to treat cancer, today announced the successful creation of its nanoparticle that can target specific cells that are potentially cancerous.  </p>"],
        ["<p>The Company’s revolutionary approach detects, and universally marks, cancer cells as viruses, such as measles. This tricks the immune system into killing cancer cells as if they were known viruses. To specifically elicit an immune response against cancer cells, CancerVax technology uses a precision 2-step cancer cell detection mechanism in highly functionalized lipid nanoparticles.   </p>"],
        ["<p>Step 1: The nanoparticle latches onto surface proteins highly expressed on cancer cells (“Marker1”). Step 2: The nanoparticle releases a proprietary Smart mRNA payload that is conditionally activated based on cancer genetic signatures (“Marker2”). When the Smart mRNA encounters a cell with the matching cancer-specific signature, it forces the cell to produce viral proteins, which disguises the cancer cell as a virus, such as measles. This makes the cancer cells recognizable to the immune system and induces immune cells to attack and kill the cancer cells. When the Smart mRNA encounters a healthy cell signature, it will not turn on, leaving the healthy cell unharmed. This two-step, on/off cancer signature detection is highly targeted to the cancer cell and is believed to improve the safety and efficacy of its treatments.   </p>"],
        ["<p>With the help of one of its world-class development partners, the Company successfully attached Marker1 molecules onto the surface of nanoparticles with high efficiency. These Marker1 conjugated nanoparticles can then seek out and deliver Smart mRNAs to cancer cells with the matching surface protein.</p>"],
        ["<p>Dr. George Katibah, Chief Scientific Officer of CancerVax said, “We anticipate that our targeted nanoparticles will improve delivery of our Smart mRNAs to cancer cells while significantly reducing uptake by healthy cells. This is potentially a game changer for increasing efficacy and reducing toxicity.” </p>"],
        ["<p>Recent positive lab confirmation demonstrated strong conjugation efficiency, which indicates that our nanoparticles can be manufactured at scale. Additional studies are being conducted to further increase efficiency rates even in preparation for clinical-grade production.</p>"],
        ["<p>Dr. Katibah commented further, “This is an important milestone for us. In February 2025, we proved that our Smart mRNA containing Marker2 worked. However, we needed a Marker1 nanoparticle to complete our innovative 2-step detection strategy. Now, we have it. These exciting results provide our team with high levels of confidence that we can successfully produce fully functional nanoparticles that can latch on to cancer cells and deliver Smart mRNAs to disguise cancer as a common disease. This is a significant, positive step towards our goal of developing a better way to treat cancer.”</p>"],
        ["<p>Dr. Adam Grant, Principal Scientist of CancerVax said, “These results are very exciting and confirm that the technology we have designed can be manufactured with limited issues. We evaluated a lot of data to give us the best chance of success, but the rubber meets the road only when we are able to validate our findings in well-designed experiments. I’m excited that what we’re seeing in the data is consistent with the expected results we hypothesized. These successful lab reports confirm that we are on the right path!” </p>"],
        ["<p>The Company’s next step is to combine Marker2 Smart mRNA payloads into Marker1 nanoparticles and create full therapeutic nanoparticles for further in-vitro optimization, and in-vivo animal testing for efficacy and toxicity. </p>"]
    ...
    [
        ...
        ["<p>Lehi, Utah, August 5, 2025 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform designed to use the body’s immune system to treat cancer, today announced that it has proven a major foundational hypothesis.</p>"],
        ["<p>The body’s immune system is very good at killing foreign pathogens, such as the measles virus or coronavirus. Unfortunately, it’s not very good at killing cancer cells, because cancer cells were originally derived from healthy cells. This is why cancer grows unchecked by the immune system and is difficult to treat. </p>"],
        ["<p>CancerVax was founded on the idea that disguising cancer cells to resemble foreign pathogens could effectively “trick” the immune system into recognizing and aggressively attacking cancer.</p>"],
        ["<h3>The Experiment</h3>"],
        ["<ul>
            <li>Over the past year, the science team vigorously researched protein fragments associated with the measles virus, coronavirus and other pathogens. </li>
            <li>Using computational analysis and AI tools, proteins were selected based on their potential to induce strong immune responses and universality across mutating viral strains. </li>
            <li>Selected protein sequences were then encoded into messenger RNAs (mRNAs) for in-vitro delivery into cancer cell lines where human T-cells were also introduced.</li>
            <li>If the “trick” was successful, the cancer cells would produce the viral related proteins and activate the co-cultured T-cells. The activation of T-cells means they recognize the cancer cells as known enemies and are ready to attack.</li>
            <li>The activation of T-cells is confirmed and measured through the cytometric counting of IFN-γ (interferon gamma) cytokines, a common procedure for measuring T-cell response.</li>
        </ul>"],
        ["<h3>The Results</h3>"],
        ["<ul>
            <li>Positive control experiments were performed using conventional immunogenic peptide mixtures to determine how much T-cell activation can be expected.</li>
            <li>CancerVax mRNAs were successfully delivered into cancer cells. The cells produced the expected proprietary proteins associated with measles, coronavirus and others. This effectively disguises the cancer cells as foreign pathogens.</li>
            <li>The CancerVax disguised cells activated T-cells to a similar extent as the positive controls.</li>
            <li><strong>In conclusion, the CancerVax trick worked, and worked very well!</strong></li>
        </ul>"],
        ["<p>“These results are a game-changer,” said Dr. George Katibah, co-inventor and the Company’s Chief Scientific Officer. “We initially expected our synthetic epitopes (proteins) to show moderate T-cell activation. Instead, they performed on par with our positive control —  a very promising outcome. These results validate the 'mark' component of our 'Detect, Mark, and Kill' precision immunotherapy approach. Next, we'll integrate these validated proteins into our Smart mRNAs and load them into our targeted nanoparticles to execute the 'detect' phase. Once cancer cells are detected and marked, the final 'kill' phase will be done by the body’s own immune cells. We're eager to combine these elements into complete therapeutic nanoparticles and begin testing in tumor-bearing mice and advance the program towards our FDA Investigational New Drug (IND) applications.”</p>"],
        ["<p>Dr. Adam Grant, co-inventor and the Company’s Principal Scientist commented, “As a career cancer researcher, I’ve experienced plenty of ups and downs with experiments that didn’t go as planned and ideas that didn’t pan out. But seeing these positive results confirms that what once seemed like a ‘crazy idea’ is, in fact, something profoundly novel and possible. I’ve never worked on a concept with such potential to transform the lives of cancer patients. Imagine a future without toxic chemotherapy, radical surgery, or tissue-damaging radiation — just harnessing the body’s amazing ability to mark and kill cancer cells” </p>"],
        ["<p>“Our science team has achieved a major milestone,” concluded Byron Elton, the Company’s CEO. “In my opinion, this represents a significant value inflection point for CancerVax.” </p>"],
        ["<p>To learn more about the CancerVax platform, please watch the Short Explainer Video at <a href=\"/explainer\" rel=\"noopener noreferrer\">https://cancervax.com/explainer</a> </p>"]
    ...
    [
        'id' => "37",
        'title' => "CancerVax Nanoparticle Successfully Targets Cancer Cells While Sparing Non-cancerous Cells",
        'date' => "June 19, 2025",
        'excerpt' => "CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform designed to use the body’s immune system to treat cancer, today announced that its ligand conjugated lipid nanoparticle (“LNP”) successfully targeted cancer cells and avoided non-cancerous cells",
        'description' => [
            
        ["<h3>In-vitro lab results confirmed that the Company’s cell targeting nanoparticles successfully entered cancer cells and avoided non-cancerous cells</h3>"],
        ["<p>Lehi, Utah – June 19, 2025 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform designed to use the body’s immune system to treat cancer, today announced that its ligand conjugated lipid nanoparticle (“LNP”) successfully targeted cancer cells and avoided non-cancerous cells.</p>"],
        ["<p>The CancerVax platform is designed to harness the body’s existing immunity to detect, mark, and kill cancer cells with precision. At the core of the platform are nanoparticles that operate via a two-step cell targeting mechanism. </p>"],
        ["<ol class=\"list-[revert] pl-12 [&_li]:pl-3\">
            <li><p><strong>Detection:</strong> The nanoparticles first bind to surface proteins highly associated with the target cancer cells (“Marker1”). </p> </li>
            <li><p><strong>Activation:</strong> Once inside the cancer cell, the LNPs release proprietary “Smart mRNA” payloads that are only activated in the presence of cancer-specific genetic signatures (“Marker2”). These Smart mRNAs instruct the cancer cells to produce proteins associated with well-immunized diseases like measles. This effectively “tricks” the immune system into killing cancer cells as if they were common diseases.</p></li>
        </ol>"],
        ["<p>Two weeks ago, the company announced that it successfully created nanoparticles with Marker1 attachments. Recent lab results confirmed that these nanoparticles entered Marker1-positive cancer cells with great efficiency, while avoiding non-cancerous cells lacking the marker.  The ultimate goal is to load up these Marker1 nanoparticles with Marker2 Smart mRNAs and make complete cancer targeting and killing nanoparticles.</p>"],
        ["<p>Dr. Adam Grant, Principal Scientist of CancerVax commented, “You never truly know how well a model will perform until it is tested in the lab. Seeing our targeted nanoparticles behave exactly as hypothesized is incredibly exciting. The Marker1 signature was selected through rigorous computational analysis. We believe that our computational approach to finding Marker1 and Marker2 signatures will allow us to move rapidly toward viable precision therapies for patients.” </p>"],
        ["<p>Dr. George Katibah, Chief Scientific Officer of CancerVax said, “These results represent a major step forward in our mission to harness the body's existing immunity to kill cancer. Seeing our engineered nanoparticles successfully distinguish between cancerous and non-cancerous cells showcases the precision of our approach and brings us closer to realizing our vision of universal, off-the-shelf cancer immunotherapy.” </p>"],
        ["<p>Dr. Sumant Ramachandra, Chief Scientific Advisor to CancerVax added, “In the short time I have worked with the research and development team at CancerVax, I have been very impressed with the systematic progress made from hypothesis generation to demonstrating selective targeting of the nanoparticle to cancer cells while sparing the non-cancerous cells. I look forward to the next milestones which will take our off-the-shelf lead program into animal studies and eventually into the IND-enabling stage.”</p>"],
        ["<p>CancerVax’s modular platform is designed for rapid customization: by changing the Marker1 and Marker2 combinations, the same nanoparticle framework can be tailored to target different types of cancer. This off-the-shelf approach means treatments can be administered quickly upon diagnosis, with the ease of an IV injection—potentially transforming the way cancer is treated.</p>"]
    ...
    [
        'id' => "36",
        'title' => "CancerVax Targets Liver Cancers to Further Showcase Flexibility of Its Universal Platform",
        'date' => "June 9, 2025",
    ...
    [
        'id' => "35",
        'title' => "CancerVax Achieves Major Milestone with Successful Creation of Cell Targeting Nanoparticle",
        'date' => "June 5, 2025",
        'excerpt' => "CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform designed to use the body’s immune system to treat cancer, today announced the successful creation of its nanoparticle that can target specific cells that are potentially cancerous",
        'description' => [
            
        ["<h3>The Company filed a substantial non-provisional PCT patent application seeking worldwide protection for its novel cancer treatment platform </h3>"],
        ["<p>Lehi, Utah, August 26, 2025 – CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform that uses the body’s immune system to treat cancer, today announced that it recently filed a foundational PCT patent application to protect its novel innovations. </p>"],
        ["<p>CancerVax was founded on the idea that disguising cancer cells to resemble foreign pathogens, such as the measles virus, could effectively “trick” the immune system into recognizing and aggressively attacking them. Recently, the Company announced that it has proven this is possible with in-vitro lab experiments – a major milestone.  </p>"],
        ["<p>Based on preliminary computational work and raw creative “outside the box” thinking, the Company filed provisional patent applications in 2024, to cover various aspects of the CancerVax platform. After a year of rigorous experimental setup and execution by world class technology partners, CancerVax has generated tremendous amounts of positive data to support the conversion of the provisional patent applications to a non-provisional PCT patent application. Claims from this patent application, if granted, may provide patent protection until 2045.</p>"],
        ["<p>The goal of the CancerVax platform is to make cancer immunotherapy scalable, affordable, and universal. The various components are based on low cost and proven technologies, such as lipid nanoparticles and mRNA. </p>"],
        ["<p>Sumant Ramachandra, MD, PhD, MBA, Chief Scientific Advisor, commented “Over my career, I’ve worked in or partnered with several of the world’s leading pharmaceutical and biotechnology companies. When I first learned about CancerVax, I thought it was a very elegant solution to a very complex problem. After watching the team achieve one positive milestone after another in a short period of time utilizing computational and experimental approaches, I believe that this novel platform has a lot of potential, perhaps even beyond cancer treatment. Having a strong patent application with supporting data for enablement and exemplification is very important. I see this patent application as the foundational root of an intellectual property (IP) tree that we will grow over time, with many potential offshoots. This approach adds significant protection and value to the Company’s efforts.”</p>"],
        ["<p>“Seeing our initial hypotheses being validated in real experiments has been incredibly satisfying,” said Adam Grant, PhD, co-inventor and Principal Scientist. “With the filing of this patent, I would now consider us a leader in this space. I am excited to be part of a team that is creating a better way to treat cancer — and perhaps, one day, a cure.”</p>"],
        ["<p>George Katibah, PhD, co-inventor and Chief Scientific Officer, said, “In the world of small biotech companies, IP is everything. This patent application supported by large amounts of data puts us on very strong footing. As we progress in our development program, it is my job to ensure that our science is rock solid, repeatable and defensible. We will continue to build our strong IP portfolio as we begin animal studies in the next month or two. These are exciting times for our company.”</p>"],
        ["<p>To learn more about the CancerVax platform, please watch the Short Explainer Video at <a href=\"/explainer\" rel=\"noopener noreferrer\">https://cancervax.com/explainer</a> </p>"]
    ...
    [
        'id' => "34",
        'title' => "CancerVax Scientists Featured on Cytiva’s “Discovery Matters” Podcast Discussing Universal Cancer Vaccine Platform",
        'date' => "June 3, 2025",
        'excerpt' => "CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform that will use the body’s immune system to fight cancer, today announced that two of its lead scientists, Dr. George Katibah and Dr. Adam Grant, were recently featured on Cytiva’s influential podcast series, Discovery Matters. The episode highlights CancerVax’s revolutionary approach to immunotherapy and its mission to create a therapy that can universally target and destroy cancer cells",
        'description' => [
        ...
        ["<p>The interview also touches on the company’s recent milestones, including successful in-vitro validation of its Smart mRNA in multiple cancer cell lines and the ongoing development of a candidate therapy for pancreatic ductal adenocarcinoma (PDAC).</p>"],
    ...
    [
        'id' => "32",
        'title' => "CancerVax Announces Successful Tests of its Smart mRNA Technology",
        'date' => "February 25, 2025",
        'excerpt' => "CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform that will use the body’s immune system to treat cancer, today announced the successful functional validation of its innovative Smart mRNA (messenger RNA) technology in lab tests",
        'description' => [
        ...
        ["<img src=\"./assets/images/fluorescene-microscopy.png\" alt=\"fluorescene-microscopy\" class=\"my-4 w-3/4 block mx-auto\">"],
        ["<ul>
            <li>When GFP Smart mRNAs were delivered into a non-cancerous cell line (HEK293), without any artificial genetic signatures, they were turned off naturally in statistically significant amounts. This confirms that Smart mRNA can detect and avoid healthy cells!</li>
        </ul>"],
        ["<img src=\"./assets/images/gfp-smart-mrnas.png\" alt=\"gfp-smart-mrnas\" class=\"my-4 w-3/4 block mx-auto\">"],
    ...
    [
        'id' => "31",
        'title' => "CancerVax Targets Hard to Treat Pancreatic Cancer",
        'date' => "December 11, 2024",
        'excerpt' => "CancerVax, Inc., the developer of a breakthrough universal cancer treatment (UCT) platform that will use the body’s immune system to treat cancer, announced today that the Company has selected Pancreatic Ductal Adenocarcinoma (PDAC) as one of its first targets for preclinical development.",
        'description' => [
    ...
    [
        'id' => "30",
        'title' => "CancerVax Lands Top Cancer Expert",
        'date' => "November 19, 2024",
        'excerpt' => "CancerVax, Inc., the developer of a breakthrough universal cancer treatment platform that will use the body’s immune system to fight cancer, announced today that Dr. George Katibah will serve as the company’s Chief Scientific Officer",
        'description' => [
    ...
    [
        'id' => "29",
        'title' => "Cancervax Taps Flashpoint Therapeutics’ Nanotechnology Platform to Drive Universal Cancer Treatment",
        'date' => "August 29, 2024",
        ...
        ["<p>Flashpoint Therapeutics is redefining drug discovery with its innovative structural nanomedicine platform. By precisely co-delivering RNA, DNA, and peptide cargo to specific target cells, our technology enables the creation of potent, multi-targeted therapies with optimized structure-function relationships and synchronized activation kinetics.</p>"]
    ...
    [
        'id' => "28",
        'title' => "Cancervax Files New Patent for Its Novel Universal Cancer Treatment Platform",
        'date' => "August 27, 2024",
        'excerpt' => "Cancervax, Inc., the developer of a breakthrough universal cancer treatment platform that will use the body’s immune system to treat cancer, today announced that the Company has recently filed a new patent application which includes a Smart mRNA Technology. mRNA, short for messenger RNA, is the underlying technology that made the COVID-19 vaccine so effective and inexpensive",
        'description' => [
    ...
    [
        'id' => "27",
        'title' => "Cancervax Adds Key Members to Its Research Team",
        'date' => "August 1, 2024",
        'excerpt' => "Cancervax, Inc., the developer of breakthrough cancer drugs that will use the body’s immune system to treat cancer, today announced that the Company has added two key members to its cancer research team. Dr. Jonathan Lakey will serve as Chief Scientific Advisor and Dr. Adam Grant will serve as Principal Scientist",
        'description' => [
    ...
    [
        'id' => "26",
        'title' => "Cancervax Successfully Uses Nobel Prize Chemistry to Achieve Universal Cancer Treatment Targeting Milestone",
        'date' => "May 21, 2024",
        'excerpt' => "Cancervax, Inc., the developer of breakthrough cancer drugs that will use the body’s immune system to treat cancer, today announced that its UCLA research team has achieved a critical milestone by creating a process to add any antibody to lipid nanoparticles (LNP) using “click chemistry”, for targeting cancer cells",
        'description' => [
    ...
    [
        'id' => "25",
        'title' => "Cancervax Announces Promising New Drug to Treat a Deadly Children’s Cancer",
        'date' => "April 16, 2024",
        'excerpt' => "Cancervax, Inc., the developer of breakthrough cancer drugs that will use the body’s immune system to treat cancer, today announced that its UCLA research team has created a promising new drug candidate for treating recurrent Ewing sarcoma, a deadly children’s cancer",
        'description' => [
            
        ["<div class=\"flex justify-center\">
            <div class=\"mb-10 lg:w-1/2 lg:flex-[0_0_auto]\" data-video=\"trend\">
                <a class=\"relative\" href=\"https://www.youtube.com/watch?v=Bk39recgMGU\">
                    <div class=\"h-auto\">
                        <img src=\"//img.youtube.com/vi/Bk39recgMGU/maxresdefault.jpg\" alt=\"Cancervax\">
                    </div>
    ...
    [
        'id' => "24",
        'title' => "Cancervax Launches $5 Million Funding Round",
        'date' => "April 3, 2024",
        'excerpt' => "Cancervax, Inc., developer of a breakthrough Universal Cancer Treatment that will use the body’s immune system to treat cancer, today announced that its Reg A+ offering has been qualified by the SEC allowing the Company to formally launch a funding round of up to $5 million. Proceeds from the SEC qualified Reg A+ offering will be used by the Company to continue work on its breakthrough cancer treatments.",
        'description' => [
        ...
        ["<p>The offering is available to the general public. For more information about the offering, please visit <a href=\"/invest\">https://cancervax.com/investors</a>.</p>"],
    ...
    [
        'id' => "23",
        'title' => "Cancervax CEO Ryan Davies Discusses Cancer Drug Development with Dr. Ezra Cohen",
        'date' => "November 2, 2023",
        'excerpt' => "Cancervax, Inc., developer of a breakthrough universal cancer treatment that uses the body’s immune system to treat cancer, today announced that in a recent Company podcast its CEO, Ryan Davies, and Tempus Labs Chief Medical Officer for Oncology Dr. Ezra Cohen, discussed his time at Tempus Labs, Moores Cancer Center and University of Chicago.",
        'description' => [
        ...
        ["<p>This Podcast can be viewed at  <a href=\"/videos/ceo-podcast/ezra-cohen-tempus-labs\">https://cancervax.com/videos/ceo-podcast/ezra-cohen-tempus-labs</a>. </p>"],
        ["<p>For more information about Cancervax, please visit <a href=\"/\">http://www.cancervax.com/</a>. </p>"]
    ...
    [
        'id' => "22",
        'title' => "Cancervax Expands Development Pipeline to Include a Universal CAR-T Cell Platform",
        'date' => "September 12, 2023",
        'excerpt' => "Cancervax, Inc., a pre-clinical biotechnology company working with UCLA to develop breakthrough immunotherapy cancer treatments that use the body’s immune system to treat cancer, today announced an expansion of its development pipeline to include a Universal CAR-T Cell Platform that can dramatically lower the cost of CAR-T cell cancer therapies",
        'description' => [
        ...
        ["<ul>
            <li>Children’s Cancer – Immunotherapy treatments for Ewing sarcoma, a children’s bone and tissue cancer with 100% death rate for recurrence. </li>
...
"]
    ...
    [
        'id' => "21",
        'title' => "Cancervax CEO Ryan Davies Discussed Cancer Immunotherapy with UCLA Physician-Scientist",
        'date' => "August 24, 2023",
        'excerpt' => "Cancervax, Inc., developer of a breakthrough universal cancer treatment that uses the body’s immune system to treat cancer, today announced that in a recent Company podcast its CEO, Ryan Davies, spoke with and UCLA cancer physician and researcher, Dr. Steven Jonas, about his journey to becoming both a practicing cancer doctor and active cancer researcher",
        'description' => [
    ...
    [
        'id' => "20",
        'title' => "World Renowned Biomedical Professor Jonathan Lakey Joins Cancervax Board of Advisors",
        'date' => "July 25, 2023",
        'excerpt' => "Dr. Lakey has been recognized nationally and internationally for his groundbreaking research in cell and tissue transplantation for patients suffering from diabetes and cancer",
        'description' => [
    ...
    [
        'id' => "19",
        'title' => "Cancervax CEO Ryan Davies Discusses Biotech Entrepreneurship with Pyxis Oncology CEO Dr. Lara Sullivan",
        'date' => "July 10, 2023",
        'excerpt' => "The two industry leaders focus on navigating the biotech industry and immuno-oncology research",
        'description' => [
        ...
        ["<p>This Podcast can be viewed at <a href=\"https://www.youtube.com/watch?v=nb4DZ-G49c8\" target=\"_blank\" rel=\"noopener noreferrer\">https://www.youtube.com/watch?v=nb4DZ-G49c8 </a></p>"],
        ["<p>For more information about Cancervax, please visit <a href=\"/\">http://www.cancervax.com/</a>. </p>"]
    ...
    [
        'id' => "18",
        'title' => "Cancervax Reports Significant Progress on Universal Cancer Treatment Development at UCLA",
        'date' => "June 27, 2023",
        'excerpt' => "Three separate teams of physician scientists at UCLA working on three different parts of the project have made significant progress and are ready to merge their work into a complete proof-of-concept vaccine construct",
        'description' => [
    ...
    [
        'id' => "17",
        'title' => "Biotech Executive Michael Smith Discusses the FDA Drug Development Process with Cancervax CEO Ryan Davies",
        'date' => "June 16, 2023",
        'excerpt' => "Michael Smith comments on the growth of immunotherapy and sees the required FDA development phases as a benefit to small biotech firms such as Cancervax",
        'description' => [
    ...
    [
        'id' => "16",
        'title' => "Cancervax Reports Positive Progress on Kids Cancer Immunotherapy Treatment ",
        'date' => "June 12, 2023",
        'excerpt' => "LEHI, Utah, June 12, 2023 (GLOBE NEWSWIRE) -- Cancervax, Inc., developer of a breakthrough universal cancer treatment that uses the body’s immune system to treat cancer, today announced",
        'description' => [
        ...
        ["<p>Ewing sarcoma is 1 of 2 major cancer research programs Cancervax has with UCLA.  For more information about Cancervax, please visit <a href=\"/\">http://www.cancervax.com/</a>. </p>"]
    ...
    [
        'id' => "15",
        'title' => "Biotech Entrepreneur and Venture Capitalist Dinesh Patel Discusses Therapeutics and Medical Devices with Cancervax CEO Ryan Davies",
        'date' => "May 17, 2023",
        'excerpt' => "Lehi, UT – May 17, 2023 – Cancervax, developer of a breakthrough universal cancer treatment that will use the body’s immune system to treat cancer, today reported that the Company’s CEO, Ryan Davies",
        'description' => [
            
        ["Lehi, UT – May 17, 2023 – Cancervax, Inc., a pre-clinical biotechnology company creating a better way to treat cancer, the developer of a breakthrough universal cancer treatment that will use the body’s immune system to fight cancer, today reported that the Company’s CEO, Ryan Davies, recently discussed the importance of developing new drugs and medical devices and their impact on the world of healthcare with biotech entrepreneur and venture capitalist Dinesh Patel."],
        ...
        ["This Podcast can be viewed at <a href=\"https://youtu.be/Um1Ca045Beg\" target=\"_blank\">https://youtu.be/Um1Ca045Beg</a>."],
        ["For more information about Cancervax, please visit <a href=\"/\">http://www.cancervax.com/</a>."]
    ...
    [
        'id' => "14",
        'title' => "Former Pfizer Legal Counsel Discusses Gene Therapy with Cancervax CEO Ryan Davies",
        'date' => "April 20, 2023",
        'excerpt' => "Stephen Diamond, Senior Vice President, General Counsel, and Secretary of Freeline, discussed his unique path from the legal and business worlds to gene therapy and next-generation therapeutics.",
        'description' => [
    ...
    [
        'id' => "13",
        'title' => "Cancervax CEO Ryan Davies Discusses Cancer Research with Leading Pediatric Hematologic Oncologist",
        'date' => "April 12, 2023",
        'excerpt' => "Dr. Satiro De Oliveira, a principal investigator in the Company’s cancer research program at UCLA, comments about the importance of cancer immunotherapy",
        'description' => [
    ...
    [
        'id' => "12",
        'title' => "Cancervax Lands Byron Elton",
        'date' => "April 3, 2023",
        'excerpt' => "Experienced business executive to help establish the Company as a significant force in the field of cancer research",
        'description' => [
    ...
    [
        'id' => "11",
        'title' => "Cancervax CEO Ryan Davies Speaks with University of Utah Chemistry Professor about the Future of Therapeutic Research",
        'date' => "March 24, 2023",
        'excerpt' => "Dr. Ryan Looper, a chemistry Professor at the University of Utah, sat down with Cancervax CEO Ryan Davies to discuss the future of novel therapeutics and how the industry can encourage young scientists to enter the field.",
        'description' => [
    ...
    [
        'id' => "10",
        'title' => "Leading Diabetes Researcher Speaks on his Groundbreaking ‘Edmonton Protocol’ with Cancervax CEO Ryan Davies",
        'date' => "March 22, 2023",
        'excerpt' => "Dr. Jonathan Lakey, Professor in University of California – Irvine’s Surgery and Biomedical Engineering departments, spoke with Cancervax CEO Ryan Davies on his accomplishments in scientific research and their impact on the world",
        'description' => [
    ...
    [
        'id' => "9",
        'title' => "Cancervax CEO Ryan Davies Sits Down with Oncology Research Leader",
        'date' => "March 20, 2023",
        'excerpt' => "Dr. David Bearss, an oncology researcher and biotech start-up founder, spoke with Cancervax CEO Ryan Davies on the future of oncology therapeutics",
        'description' => [
        ...
        ["<p>This CEO Chat can be viewed at <a href=\"https://youtu.be/EMohSGJWZBQ\" target=\"_blank\">https://youtu.be/EMohSGJWZBQ</a></p>"],
        ["<p>For more information about Cancervax, please visit <a href=\"/\">https://www.cancervax.com/</a>.</p>"]
    ...
    [
        'id' => "8",
        'title' => "Cancervax Universal Cancer Treatment Being Developed by UCLA",
        'date' => "March 17, 2023",
        'excerpt' => "The UCLA research team, which includes Dr. Steven Jonas, Dr. Christopher Seet, Dr. Satiro De Oliveira and Dr. Christopher Denny, will leverage cutting-edge technologies to develop a breakthrough universal cancer treatment that will train the body to target and destroy cancer cells.",
        'description' => [
    ...
    [
        'id' => "7",
        'title' => "Cancervax Files Non-Provisional Patent for Universal Cancer Treatment",
        'date' => "March 16, 2023",
        'excerpt' => "The Company’s patent application describes how it plans to leverage cutting-edge CRISPR and mRNA technologies to develop a breakthrough universal cancer treatment",
        'description' => [
    ...
    [
        'id' => "5",
        'title' => "Cancervax Files Provisional Patent for a Universal Cancer Treatment",
        'date' => "October 6, 2021",
        'excerpt' => "The Company plans to leverage cutting-edge CRISPR and mRNA technologies in its quest to develop a breakthrough universal cancer treatment.",
        'description' => [
    ...
    [
        'id' => "4",
        'title' => "Biotech Executive Joins Cancervax",
        'date' => "October 1, 2021",
        'excerpt' => "New CEO Ryan Davies will lead the Company’s development of its breakthrough immunotherapy treatment SANTA BARBARA, CA – October 1, 2021 – Cancervax, Inc.",
        'slug' => "biotech-executive-joins-cancervax.php",
        'description' => [
    ...
    [
        'id' => "3",
        'title' => "Cancervax Announces Research Program",
        'date' => "May 26, 2021",
        'excerpt' => "The Company has entered into an agreement with UCLA to develop an immunotherapy breakthrough targeted at treating Ewing sarcoma, a rare but deadly soft tissue and bone cancer that primarily affects children and young adults.",
        'slug' => "cancervax-announces-research-program.php",
        'description' => [
    ...
    [
        'id' => "2",
        'title' => "Cancervax Closes Series A Funding Round",
        'date' => "March 30, 2021",
        'excerpt' => "SANTA BARBARA, CA – March 30, 2021 – Cancervax, Inc., a developer of immunotherapy cancer treatments that use the body’s immune system to treat cancer, today announced it has closed its $2 million series A funding round.",
        'slug' => "cancervax-closes-series-a-funding-round.php",
        'description' => [
    ...
    [
        'id' => "1",
        'title' => "Cancervax Launched",
        'date' => "March 23, 2021",
        'excerpt' => "The Company was founded by experienced healthcare executive Lindsay Mann",
        'slug' => "cancervax-launched.php",
        'description' => [
