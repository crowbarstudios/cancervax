<section class="py-20 bg-[#fafdfa]">
    <div class="container">
        <div class="max-w-[516px] md:max-w-[696px] xl:max-w-[856px] bg-white mx-auto px-6 pt-10 pb-6 shadow-2xl rounded-2xl">
            <h1 class ="text-2xl sm:text-[34px] mb-2 sm:leading-10 tracking-[.05px] font-bold">IMPORTANT Ceo Update About Bonus Shares</h1>
            <div class="[&>p]:my-[14px] [&>p]:text-sm [&>p]:tracking-[.05px] [&_span]:text-lg [&_span]:!leading-5">
                <p>Ryan Davies, CEO of CancerVax, recently thanked investors and urged everyone to <strong><span>take advantage of valuable investor perks.&nbsp;</span></strong></p>
                ...
                <p class="text-center"><strong><span>Help us in the fight against cancer by investing in CancerVax.</span></strong></p>
            </div>
