<section class="py-20 bg-[#fafdfa]">
    <div class="container">
        <div class="max-w-[516px] md:max-w-[696px] xl:max-w-[856px] bg-white mx-auto px-6 pt-10 pb-6 shadow-2xl rounded-2xl">
            <h1 class ="text-2xl sm:text-[34px] mb-2 sm:leading-10 tracking-[.05px] font-bold">CANCER EPIDEMIC has a viable solution</h1>
            <div class="my-[14px] pt-6">
                <img src="./assets/images/inpost-4.png" alt="invest post">
            </div>
            <div class="[&>p]:my-[14px] [&>p]:text-sm [&>p]:tracking-[.05px] [&_span]:text-lg [&_span]:!leading-5">
                <p><a href="https://www.sciencedirect.com/science/article/pii/S2667193X22001120" class="underline text-purple-900" target="_blank" rel="noopener noreferrer"><strong>https://www.sciencedirect.com/science/article/pii/S2667193X22001120</strong></a></p>
