...
<section class="py-[70px] sm:pt-[140px] sm:pb-20 bg-white">
    <div class="container">
        <h2 class="text-[40px] leading-none mb-20 font-medium text-black">Short Videos</h2>
    </div>
</section>

<section class="bg-white pb-20 sm:pb-32">
    <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 text-black">
            <?php
