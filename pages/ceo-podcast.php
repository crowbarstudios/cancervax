...
<section class="py-[70px] sm:pt-[140px] sm:pb-20 bg-white">
    <div class="container">
        <h2 class="text-[40px] leading-none mb-20 font-medium text-black">Podcast</h2>
        <div class="max-w-[600px] mx-auto flex items-center justify-center gap-5 flex-col sm:flex-row">
            <div class="min-w-[160px]">
                <img src="./assets/images/Ryan-Davies.png" class="w-full" alt="ryan">
            </div>
            <p class="text-black text-base leading-7 text-center">Watch our CEO, Ryan Davies, chat with leaders and experts in the biotech industry about trends, insights as well as progress with CancerVax</p>
        </div>
    </div>
</section>
