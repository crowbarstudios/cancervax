    ...
    <div class="bg-banner-mobile md:bg-banner bg-white bg-no-repeat bg-[top_center] bg-cover h-[245px] sm:h-[480px] md:h-[850px] xl:!h-auto xl:min-h-[900px] banner-home-up relative">
        <div class="container">
            ...
            <div class="relative top-12 pt-[50px] xl:pt-4 max-w-[530px] xl:max-w-[615px]">
                <ul class="hidden md:block max-w-[50%] lg:max-w-[81%] xl:max-w-[98%] space-y-3.5">
                    <li class="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 px-5 py-4 pl-[4.5rem] shadow-[0_10px_25px_rgba(42,92,110,0.12)] backdrop-blur-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_30px_rgba(42,92,110,0.18)]">
                        <span class="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-custom-orange-100 to-custom-teal-100"></span>
                        <span class="absolute left-4 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-custom-teal-300 text-xs font-bold tracking-wide text-white shadow-[0_5px_12px_rgba(42,92,110,0.22)]">01</span>
                        <span class="block text-lg font-medium leading-snug text-black xl:text-xl"><strong class="font-bold text-custom-teal-300">Last year, 10 million people died</strong> because the body does not easily recognize and kill cancer cells.</span>
                    </li>
                    <li class="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 px-5 py-4 pl-[4.5rem] shadow-[0_10px_25px_rgba(42,92,110,0.12)] backdrop-blur-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_30px_rgba(42,92,110,0.18)]">
                        <span class="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-custom-orange-100 to-custom-teal-100"></span>
                        <span class="absolute left-4 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-custom-orange-100 text-xs font-bold tracking-wide text-white shadow-[0_5px_12px_rgba(242,167,67,0.25)]">02</span>
                        <span class="block text-lg font-medium leading-snug text-black xl:text-xl"><strong class="font-bold text-custom-teal-300">However, the body is very good at killing diseases</strong> that it recognizes, such as measles.</span>
                    </li>
                    <li class="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 px-5 py-4 pl-[4.5rem] shadow-[0_10px_25px_rgba(42,92,110,0.12)] backdrop-blur-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_30px_rgba(42,92,110,0.18)]">
                        <span class="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-custom-orange-100 to-custom-teal-100"></span>
                        <span class="absolute left-4 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-custom-teal-100 text-xs font-bold tracking-wide text-white shadow-[0_5px_12px_rgba(42,92,110,0.2)]">03</span>
                        <span class="block text-lg font-medium leading-snug text-black xl:text-xl"><strong class="font-bold text-custom-teal-300">Our breakthrough technology disguises cancer cells</strong> to look like measles and <em class="font-semibold text-custom-orange-100">“tricks”</em> the body into killing them.</span>
                    </li>
                </ul>
            </div>
    ...
    <div class=" shadow-[0px_-3px_20px_11px_#fff] sm:shadow-[0px_-20px_20px_20px_#fff] md:shadow-none md:hidden">
        <div class="container relative top-12">
            <div class="max-w-[530px]">
                <ul class="w-full max-w-[530px] space-y-3.5">
                    <li class="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 px-4 py-4 pl-[4.25rem] shadow-[0_10px_25px_rgba(42,92,110,0.12)] backdrop-blur-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_30px_rgba(42,92,110,0.18)]">
                        <span class="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-custom-orange-100 to-custom-teal-100"></span>
                        <span class="absolute left-3.5 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-custom-teal-300 text-xs font-bold tracking-wide text-white shadow-[0_5px_12px_rgba(42,92,110,0.22)]">01</span>
                        <span class="block text-lg font-medium leading-snug text-black"><strong class="font-bold text-custom-teal-300">Last year, 10 million people died</strong> because the body does not easily recognize and kill cancer cells.</span>
                    </li>
                    <li class="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 px-4 py-4 pl-[4.25rem] shadow-[0_10px_25px_rgba(42,92,110,0.12)] backdrop-blur-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_30px_rgba(42,92,110,0.18)]">
                        <span class="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-custom-orange-100 to-custom-teal-100"></span>
                        <span class="absolute left-3.5 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-custom-orange-100 text-xs font-bold tracking-wide text-white shadow-[0_5px_12px_rgba(242,167,67,0.25)]">02</span>
                        <span class="block text-lg font-medium leading-snug text-black"><strong class="font-bold text-custom-teal-300">However, the body is very good at killing diseases</strong> that it recognizes, such as measles.</span>
                    </li>
                    <li class="group relative overflow-hidden rounded-2xl border border-white/80 bg-white/90 px-4 py-4 pl-[4.25rem] shadow-[0_10px_25px_rgba(42,92,110,0.12)] backdrop-blur-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_30px_rgba(42,92,110,0.18)]">
                        <span class="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-custom-orange-100 to-custom-teal-100"></span>
                        <span class="absolute left-3.5 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-custom-teal-100 text-xs font-bold tracking-wide text-white shadow-[0_5px_12px_rgba(42,92,110,0.2)]">03</span>
                        <span class="block text-lg font-medium leading-snug text-black"><strong class="font-bold text-custom-teal-300">Our breakthrough technology disguises cancer cells</strong> to look like measles and <em class="font-semibold text-custom-orange-100">“tricks”</em> the body into killing them.</span>
                    </li>
                </ul>
            </div>
        </div>
