<section class="py-28">
    <div class="container">
        ...
        <div class="mb-12 text-center">
            <h1 class="text-3xl sm:text-5xl !leading-[1.3] font-medium">You can now invest in CancerVax <br class="hidden md:block"> and join our fight to cure cancer!</h1>
        ...
        <h3 class="text-custom-teal-300 text-2xl mb-3 mt-6">Stock Transfer Agent​</h3>
        ...
        <p class="mt-6 mb-4 italic text-base leading-normal">The Reg CF offering is made available through StartEngine Primary, LLC, member FINRA/SIPC. This investment is speculative, illiquid, and involves a high degree of risk, including the loss of your entire investment.</p>
    </div>
</section>