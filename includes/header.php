        ...
        <div class="bg-custom-teal-100 p-2.5 sm:py-2 sm:px-8 min-h-16">
            <div class="container-fluid">
                <div class="flex items-center justify-between">
                    ...
                    <a href="https://investment.startengine.com/cancervax" target="_blank" class="theme-btn orange-btn !border-0 !text-[15px] tracking-normal !uppercase mx-auto md:mx-0">LEARN HOW TO INVEST IN CANCERVAX</a>
